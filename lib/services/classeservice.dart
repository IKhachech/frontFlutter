...
Future addAbsence(Absence absence) async {
  Response response =
      await http.post(Uri.parse("http://localhost:8089/absence/add"),
...
Future updateAbsence(Absence absence) async {
  Response response =
      await http.put(Uri.parse("http://localhost:8089/absence/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
...
Future deleteAbsence(int? id) {
  return http
      .delete(Uri.parse("http://localhost:8089/absence/delete?id=${id}"));
}

Future addMatier(Matier matier, int classId) async {
  Response response = await http.post(
      Uri.parse("http://localhost:8089/matier/add/$classId"),
      headers: {"Content-type": "Application/json"},
      body: jsonEncode(<String, dynamic>{
...
Future updateMatier(Matier matier) async {
  Response response =
      await http.put(Uri.parse("http://localhost:8089/matier/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
...
Future deleteMatier(int id) {
  return http.delete(Uri.parse("http://localhost:8089/matier/delete?id=${id}"));
}

Future deleteClass(int id) {
  return http.delete(Uri.parse("http://localhost:8089/class/delete?id=${id}"));
}

Future addClass(Classe classe) async {
  Response response = await http.post(
      Uri.parse("http://localhost:8089/class/add"),
      headers: {"Content-type": "Application/json"},
      body: jsonEncode(<String, dynamic>{
...
Future updateClasse(Classe classe) async {
  Response response =
      await http.put(Uri.parse("http://localhost:8089/class/update"),
          headers: {"Content-type": "Application/json"},
          body: jsonEncode(<String, dynamic>{
